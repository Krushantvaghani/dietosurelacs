...
import 'package:dietosurelabs/global/utility/index.dart';
      ...
      child: Container(
        ...
        child: Material(
          ...
          child: InkWell(
            ...
            child: Container(
              padding: EdgeInsets.all(appScreenUtil.size(
                  padding)), //.symmetric(vertical: appScreenUtil.size(padding), horizontal: appScreenUtil.size(padding)),
              width: width != null
                  ? appScreenUtil.size(width)
              ...
              child: Row(
                ...
                children: [
                  if (icon != null)
                    Row(
                      children: [
                        Icon(icon,
                            color: iconColor,
                            size: appScreenUtil.size(iconSize)),
                  ...
                  Text(
                    title!,
                    style: style ??
                        appCss.bodyStyle4.copyWith(color: appColor.whiteColor),
